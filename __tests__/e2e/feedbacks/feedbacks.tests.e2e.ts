...
describe('/feedback tests', () => {
    ...
    it('should return page 3 and page size 3', async () => {
        ...
        await request(app)
            .get(`${RouterPaths.posts}/${post.createdEntity.id}/comments?pageSize=3&pageNumber=3`)
            .expect(HTTP_STATUSES.OK_200,
                {
                    pagesCount: 4,
                    page: 3,
    ...
    it('should return posts "asc" ', async () => {
        ...
        await getRequest()
            .get(`${RouterPaths.posts}/${post.createdEntity.id}/comments?pageSize=15&sortDirection=asc`)
